...
| `backend/api/src/modules/company-recruiting` | `CompanyRecruitingController` | `/api/v1/company/recruitments`, `/api/v1/company/applicants` | B | API-010..033 중 공고/지원자 운영, API-080, API-085..086 |
