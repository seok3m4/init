...
| `backend/api/src/modules/company-recruiting` | `CompanyRecruitingController`, `PublicRecruitmentController` | `/api/v1/company/recruitments`, `/api/v1/company/applicants`, `/api/v1/public/recruitments` | B | API-010..033 중 공고/지원자 운영, API-080, API-085..088 |
...
| API-088 | 공개 - 채용공고/지원 | POST | /public/recruitments/{recruitmentId}/applications/status | 공개 지원 현황 조회 | 비로그인 허용 | N | 200 OK |
