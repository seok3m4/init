...
| API-039E | 기업 - 면접관리 | POST | /company/interviews/hiring-simulations/{cohortId}/lock | NCS·인재상 평가 컨텍스트 고정 및 코호트 잠금 | 기업 / 기업 사용자 로그인 | N | 200 OK |
| API-039F | 기업 - 면접관리 | POST | /company/interviews/hiring-simulations/{cohortId}/answer-evaluations | 저장된 지원자 답변의 NCS·인재상 이중 평가 작업 생성 | 기업 / 기업 사용자 로그인 | Y | 202 Accepted |
