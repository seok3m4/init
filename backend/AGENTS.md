...
Node.js + TypeScript 백엔드 영역이다. NestJS API 서버, AI/비동기 worker, common 모듈로 나눈다.

## Structure

- `api`: NestJS REST API 서버와 Prisma schema
- `worker`: SQS/OpenAI Agents SDK/MediaPipe 기반 비동기 worker
